...
const FRONTEND_SERVER_URL = process.env.FRONTEND_URL || 'http://localhost:8081'; // 前端服务地址
const LOCAL_SERVER_URL = process.env.BACKEND_URL || 'http://localhost:3000'; // 后端服务地址
const REAL_SERVER_URL = process.env.BACKEND_URL || 'http://localhost:3000'; // 后端服务地址
